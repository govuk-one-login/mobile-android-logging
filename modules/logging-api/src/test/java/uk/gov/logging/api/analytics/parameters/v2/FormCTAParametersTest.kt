...
class FormCTAParametersTest {

    @Test
    fun `text parameter value is truncated to be 100 characters or less`() {
        // Given FormCTAParameters with text longer than 100 characters
        val parameters = FormCTAParameters(
    ...
    fun `response parameter value is truncated to be 100 characters or less`() {
        // Given FormCTAParameters with response longer than 100 characters
        val parameters = FormCTAParameters(
            text = "Test Button",
