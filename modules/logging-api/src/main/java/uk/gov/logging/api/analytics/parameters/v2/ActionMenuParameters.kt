...
/**
 * Data class to build the key value parameter pairs required for the TrackEventActionMenu
 * AnalyticsEvent. Use TrackEventActionMenu to monitor the number of times users
 * are shown popup action menus (those that don't require user select to dismiss).
 *
