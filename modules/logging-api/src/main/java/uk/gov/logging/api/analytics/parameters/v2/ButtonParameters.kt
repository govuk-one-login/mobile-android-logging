...
/**
 * Data class to build the key value parameter pairs required for the TrackEventButton
 * AnalyticsEvent. Use TrackEventButton to monitor the number of times users
 * interact with features that progress them to a new section of their journey.
 *
