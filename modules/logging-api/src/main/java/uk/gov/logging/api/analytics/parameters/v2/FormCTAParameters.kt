...
/**
 * Data class to build the key value parameter pairs required for the TrackEventFormCallToAction
 * AnalyticsEvent. Use TrackEventFormCallToAction to monitor the number of times users
 * respond to questions in a non dismissible call to action form i.e. allow camera permissions.
 *
