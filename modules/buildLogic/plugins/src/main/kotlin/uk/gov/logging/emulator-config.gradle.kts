...
import uk.gov.logging.emulator.SystemImageSource.GOOGLE_ATD
import uk.gov.logging.emulator.SystemImageSource.GOOGLE_PLAYSTORE
import uk.gov.logging.extensions.BaseExtensions.generateDeviceConfigurations
import uk.gov.logging.extensions.BaseExtensions.generateGetHardwareProfilesTask
