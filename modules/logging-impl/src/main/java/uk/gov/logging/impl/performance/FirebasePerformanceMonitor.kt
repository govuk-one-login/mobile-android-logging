...
class FirebasePerformanceMonitor(private val performance: FirebasePerformance) : PerformanceMonitor {
    ...
    class Trace(private val delegate: FirebaseTrace) : PerformanceMonitor.Trace {
    ...
    class HttpMetric(private val delegate: FirebaseHttpMetric) : PerformanceMonitor.HttpMetric {
